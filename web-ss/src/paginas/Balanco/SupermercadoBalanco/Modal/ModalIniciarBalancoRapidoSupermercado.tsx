...
import {
    ...
    analiseBalancoDespesaHospital, AnaliseBalancoDespesaHospital, balancoHospitalEnum
...
const ModalIniciarBalancoRapidoSupermercado: React.FC<BasicModalProps> = ({ onClose }) => {
...
export default ModalIniciarBalancoRapidoSupermercado;