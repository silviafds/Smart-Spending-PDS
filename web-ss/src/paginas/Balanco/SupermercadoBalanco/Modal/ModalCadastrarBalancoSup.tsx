...
import {
    ...
    analiseBalancoDespesaHospital, analiseBalancoDespesaSupermercado, AnaliseBalancoDespesaSupermercado
...
const ModalCadastrarBalancoSup: React.FC<BasicModalProps & { id: any }> = ({ onClose, id }) => {
    ...
    const handleBalanco = async (tipoBalanco: any) => {
        if(tipoBalanco != null) {
            ...
            if(tipoBalanco.nome === AnaliseBalancoDespesaSupermercado.ENTREGA ||
                tipoBalanco.nome === AnaliseBalancoDespesaSupermercado.RELACIONAMENTO_CLIENTES
            || tipoBalanco.nome === AnaliseBalancoDespesaSupermercado.SERVICOS_TERCEIRIZADOS) {
                        ...
                        {balanco === "Despesa" && (
                            <>
                                <div
                                    ...
                                    <Selector dado={analiseBalancoDespesaSupermercado}
...
export default ModalCadastrarBalancoSup;