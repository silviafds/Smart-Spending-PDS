...
import {
    ...
    AnaliseBalancoDespesaHospital,
    balancoHospitalEnum,
    AnaliseBalancoDespesaRestaurante,
    analiseBalancoDespesaRestaurante
...
const ModalIniciarBalancoRapidoRestaurante: React.FC<BasicModalProps> = ({ onClose }) => {
...
export default ModalIniciarBalancoRapidoRestaurante;