...
import {
    ...
    analiseBalancoDespesaHospital,
    analiseBalancoDespesaSupermercado,
    AnaliseBalancoDespesaSupermercado,
    AnaliseBalancoDespesaRestaurante, analiseBalancoDespesaRestaurante
...
const ModalCadastrarBalancoRestaurante: React.FC<BasicModalProps & { id: any }> = ({ onClose, id }) => {
    ...
    const handleBalanco = async (tipoBalanco: any) => {
        if(tipoBalanco != null) {
            ...
            console.log("kflsfjsd "+tipoBalanco.nome)
            if(tipoBalanco.nome === AnaliseBalancoDespesaRestaurante.TREINAMENTO_FUNCIONARIO ||
                tipoBalanco.nome === AnaliseBalancoDespesaRestaurante.DECORACAO_AMBIENTE
            || tipoBalanco.nome === AnaliseBalancoDespesaRestaurante.MARKETING_PROPAGANDA) {
                        ...
                        {balanco === "Despesa" && (
                            <>
                                <div
                                    ...
                                    <Selector dado={analiseBalancoDespesaRestaurante}
...
export default ModalCadastrarBalancoRestaurante;